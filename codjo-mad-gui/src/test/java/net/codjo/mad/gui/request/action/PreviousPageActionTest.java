...
public class PreviousPageActionTest {
    private PreviousPageAction action;
    ...
    public void setUp() throws Exception {
        ...
        action = new PreviousPageAction(guiContext, table);

        dataSource.setHasPreviousPage(true);
    ...
    public void test_actionPerformed() throws Exception {
        ...
        log.assertContent("loadPreviousPage()");
    }
    ...
    public void test_enabled() throws Exception {
        ...
        dataSource.setHasPreviousPage(false);
        table.load();
